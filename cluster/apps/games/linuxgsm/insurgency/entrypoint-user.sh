...
# Pulled from https://github.com/GameServerManagers/docker-linuxgsm/blob/main/entrypoint-user.sh
# Required for source mod install until https://github.com/GameServerManagers/docker-linuxgsm/issues/25 is addressed
